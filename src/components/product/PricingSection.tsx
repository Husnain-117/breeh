...
const plans = [
    {
        ...
        annual: 239,
        popular: false,
        features: ["Up to 500 calls/month", "Basic scheduling", "Email support", "Standard EHR integrations", "Call recording"],
    ...
    },
    {
        ...
        annual: 479,
        popular: true,
        features: ["Unlimited calls", "Multi-provider scheduling", "Priority phone support", "Operational analytics", "Multi-location (up to 5)", "Custom integrations", "SMS follow-ups"],
            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="flex justify-center items-center gap-4 mb-12">
                    ...
                    <button onClick={() => setAnnual(!annual)}
                        ...
                        style={{ backgroundColor: annual ? "hsl(var(--primary))" : "" }}>
                    ...
                    {plans.map((plan, i) => (
                        <motion.div key={plan.name} initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}
                            ...
                            <div className="mt-6 mb-6">
                                {plan.monthly ? (
                                    <>
                                        <span className="font-display font-bold text-4xl text-foreground">${annual ? plan.annual : plan.monthly}</span>
                                        <span className="text-muted-foreground text-sm">/month</span>
                                        {annual && <p className="text-xs text-muted-foreground mt-1"><span className="line-through">${plan.monthly}</span> billed annually</p>}
                                    </>
                                ) : (
