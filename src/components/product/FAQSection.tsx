...
const faqs = [
    { q: "How quickly can I get started with Breeh?", a: "You can set up Breeh in as little as 5–10 minutes. Connect your phone system through simple call forwarding, link your EHR/EMR, and you're live. No hardware installation required.", cat: "Getting Started" },
    ...
    { q: "What EHR/EMR systems does Breeh integrate with?", a: "We integrate with 50+ systems including Epic, Cerner, Athenahealth, eClinicalWorks, NextGen, Allscripts, Meditech, DrChrono, and more. Two-way sync ensures appointments and patient data stay up to date.", cat: "Features" },
    { q: "How does the AI handle complex patient questions?", a: "Breeh AI is trained on healthcare-specific scenarios and can handle scheduling, insurance questions, urgent triage, and general inquiries across any specialty. For complex cases beyond its scope, it seamlessly transfers to your team with full context.", cat: "Features" },
    { q: "Is Breeh HIPAA compliant?", a: "Absolutely. Breeh is fully HIPAA compliant with SOC 2 Type II certification. All data is encrypted with AES-256, and we maintain comprehensive audit logs. We sign BAAs with all healthcare clients.", cat: "Security" },
    ...
    { q: "How does Breeh handle after-hours calls?", a: "Breeh operates 24/7/365. After-hours calls are handled with the same quality — AI answers, books appointments, handles urgent triage, and sends your team a summary for the morning.", cat: "Features" },
    { q: "Can I customize the AI's voice and responses?", a: "Yes, you can customize the AI's greeting, tone, and specific responses for each department or specialty. Enterprise plans also include custom AI training on your specific protocols.", cat: "Features" },
];
                ...
                <div className="space-y-3">
                    <AnimatePresence mode="popLayout">
                        {filtered.map((faq, i) => {
                            ...
                            return (
                                <motion.div key={faq.q} layout initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, scale: 0.95 }} transition={{ duration: 0.2 }}
