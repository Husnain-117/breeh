                    ...
                    {messages.map((msg, i) => (
                        ...
                        >
                            <div className="max-w-[82%]">
                                <div
                                    className={`px-3 py-2 rounded-2xl text-[11px] leading-relaxed ${msg.role === "patient"
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8 w-full pt-32 pb-20 md:pt-36 md:pb-24">
                <div className="flex flex-col lg:flex-row items-center gap-14 lg:gap-10">
                    ...
                    <div className="lg:w-[55%] text-center lg:text-left">
                        ...
                        >
                            Every Feature Your Healthcare Team Needs
                        </motion.h1>
                        ...
                        >
                            From intelligent call handling to multi-provider scheduling, patient follow-ups, and operational analytics — all in one HIPAA-compliant platform.
                        </motion.p>
