        ...
        <section className="py-24 px-6 bg-background relative overflow-hidden">
            ...
            <div className="container max-w-5xl mx-auto">
                <motion.div
                    ...
                    viewport={{ once: true }}
                    className="bg-gradient-to-br from-primary to-purple-600 rounded-[48px] p-12 md:p-24 text-center text-white relative shadow-2xl shadow-primary/25 overflow-hidden"
                >
                    <motion.div
                    ...
                    >
                        ...
                        <h2 className="text-4xl md:text-6xl font-bold mb-8 font-display leading-[1.1]">
                            Join healthcare organizations thriving with Breeh
                        </h2>
